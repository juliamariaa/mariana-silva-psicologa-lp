...
const Hero = () => {
  ...
  return (
    <section aria-labelledby="hero-title" className="bg-[url('/src/assets/background-hero.webp')] bg-cover bg-center">
      <div className='max-w-[1409px] lg:max-h-[800px] flex flex-col lg:flex-row items-center lg:justify-between md:mx-auto pt-5 xl:pt-0 px-3 2xl:px-0'>
        ...
        <div className="max-w-[550px] flex flex-col gap-3 xl:gap-4">
          ...
          <div className='flex flex-col'>
            <h1 id="hero-title" className="font-serif text-[48px] lg:text-[64px] text-terciary leading-tight">Sua psicóloga</h1>
