...
const InstagramSection = () => {
  return (
    <section aria-labelledby="instagram-section-title" className='bg-primary'>
      <div className='max-w-[1409px] mx-auto pt-10 lg:pt-14 pb-[321px] px-3 2xl:px-0 flex flex-col items-center gap-8'>

        <SectionHeader id="instagram-section-title" tag="Novidades toda semana" title="Acompanhe nosso instagram" colorTag="text-white" colorTitle="text-white" />
